...
public class LoginController implements Serializable {
    ...
    @EJB
    private com.senac.elevcallsdefinitivo.controller.LoginFacade ejbFacade;
    ...
    public String loginSystem() {
        if (login.getUsuario().equals(this.getLogin().getUsuario()) && login.getSenha().equals(this.getLogin().getSenha())) {
            HttpSession session = (HttpSession) FacesContext.getCurrentInstance().getExternalContext().getSession(false);
            session.setAttribute("usuario", login);

            return "/chamadas/List?faces-redirect=true";
