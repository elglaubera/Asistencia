 ...
 */
@Stateless
public class ProgramacionParticularFacade extends AbstractFacade<ProgramacionParticular> {
    ...
    public ProgramacionParticularFacade() {
        super(ProgramacionParticular.class);
    }
