 ...
 */
@Stateless
public class PrecioAsistenciaXinermedFacade extends AbstractFacade<PrecioAsistenciaXinermed> {
    ...
    public PrecioAsistenciaXinermedFacade() {
        super(PrecioAsistenciaXinermed.class);
    }
