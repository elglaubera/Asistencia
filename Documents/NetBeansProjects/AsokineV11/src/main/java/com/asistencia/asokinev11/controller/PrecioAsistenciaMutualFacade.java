 ...
 */
@Stateless
public class PrecioAsistenciaMutualFacade extends AbstractFacade<PrecioAsistenciaMutual> {
    ...
    public PrecioAsistenciaMutualFacade() {
        super(PrecioAsistenciaMutual.class);
    }
