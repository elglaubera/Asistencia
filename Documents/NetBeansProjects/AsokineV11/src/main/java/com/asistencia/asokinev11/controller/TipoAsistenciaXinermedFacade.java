 ...
 */
@Stateless
public class TipoAsistenciaXinermedFacade extends AbstractFacade<TipoAsistenciaXinermed> {
    ...
    public TipoAsistenciaXinermedFacade() {
        super(TipoAsistenciaXinermed.class);
    }
